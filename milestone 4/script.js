...
// Add event listeners to make elements editable on click
document.querySelectorAll('[contenteditable]').forEach(function (element) {
    // Cast element to HTMLElement to access specific properties
    var editableElement = element;
    // Save updated content on losing focus
    editableElement.addEventListener('blur', function () {
        // Optionally, you could save the data to localStorage or call an API here
    });
});
